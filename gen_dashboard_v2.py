...
.prod-champ-th{font-size:11.5px;font-weight:500;color:var(--sub);margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
thead th{position:sticky;top:0;background:var(--head-bg);z-index:2;text-align:left;vertical-align:top;padding:14px 12px;font-size:13.5px;font-weight:600;color:var(--head-txt);border-bottom:1px solid var(--line);white-space:nowrap}
    ...
    <div class="tbl-wrap">
      <table>
        ...
        <thead><tr>
          ...
          <th>工作量</th><th>开始</th><th>产品<div class="prod-champ-th">🏆 耗时冠军 <b>__CHAMP_SHORT__</b></div></th><th>客户项目</th><th>开发人</th>
        </tr></thead>
