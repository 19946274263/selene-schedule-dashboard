...
thead th{position:sticky;top:0;background:var(--head-bg);z-index:2;text-align:left;padding:14px 12px;font-size:13.5px;font-weight:600;color:var(--head-txt);border-bottom:1px solid var(--line);white-space:nowrap}
